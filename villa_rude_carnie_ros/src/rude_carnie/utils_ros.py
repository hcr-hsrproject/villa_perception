...
def make_batch(image_data, coder, multicrop):
...
#    result, encimg = cv2.imencode('.jpeg', image_data, encode_param)

    image = np.asarray(image_data)
    print(image.shape)

    print('make_batch 1 before decode')
 #   image = coder.decode_jpeg(encimg)
    print('make_batch 2')
