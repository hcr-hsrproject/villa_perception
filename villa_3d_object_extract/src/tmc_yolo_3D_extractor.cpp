...
*/
	...
	//Subscribe to images
	// Subscription to image
	bbh_obj.image_sub = bbh_obj.node.subscribe<sensor_msgs::Image>("/hsrb/head_rgbd_sensor/rgb/image_rect_color", 1000, boost::bind(&Bounding_Box_dobject::ImageCallback, &bbh_obj, _1));	
	//Subsribe to points
