...
#Node index
    ...
    def __init__(self, name):
        ...
        rospy.Subscriber('/pose_estimation/estimations',Estimations,self.estimation_callback)
    ...
    def process_person(self, person):
        ...
        for i in range(NODES):
            xCoord[i] = person.body[i + NODES*person.id].x
            yCoord[i]= person.body[i+ NODES*person.id].y
        # xCoord = [part.x for part in person.body]                                              #array of x coordinates for nodes of a person
        # yCoord = [part.y for part in person.body]                                              #array of y coordinates for nodes of a person
        ...
        yLeftLeg = 0;                                                                   #dummy initialization
        yRightLeg = 0;                                                                  #dummy initialization
        pose = 0;                                                                       #dummy initialization
